<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="cCanto.aspx.cs" Inherits="CelebracionSistemaWeb2._0.UI.Consultas.cCanto" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-2">
                        ...
                        <asp:DropDownList ID="DropDownListFiltro" CssClass="form-control" runat="server">
                            ...
                            <asp:ListItem>Nombre del Canto</asp:ListItem>
                       </asp:DropDownList>
                    </div>
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-lg-11">
                        <asp:GridView ID="GridView" runat="server" AllowPaging="True" PageSize="50" CssClass="table table-striped table-hover table-responsive-lg" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                <asp:BoundField DataField="CantoId" HeaderText="Canto Id" />
                                <asp:BoundField DataField="Nombre" HeaderText="Nombre del Canto" />
